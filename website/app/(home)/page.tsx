...
export const metadata: Metadata = {
  title: { absolute: 'Haypile: private document search for you and your AI agents' },
  description:
    'One binary that watches your folders, indexes every PDF, Word file, and note, and serves cited passages to you and any MCP agent. Fully local semantic search: no cloud, no Python, no vector database, zero outbound connections.',
...
const jsonLd = {
  ...
  description:
    'Private search and Q&A for your documents, with MCP for AI agents. One binary indexes PDF, Word, Markdown, and text files locally and answers questions with citations. Zero outbound network connections.',
...
const features: {
  ...
  {
    title: 'Give your agent your documents',
  ...
  },
  {
    ...
    body: 'Your local LLM answers from the retrieved passages and cites the file and page for every claim, so a wrong answer has nowhere to hide. Fully offline: it works on a plane, and on documents that are not allowed near a cloud. Prefer a stronger model? Bring your own API key; only the retrieved passages for that one question are sent, and only because you asked.',
    ...
    <main className="flex flex-1 flex-col">
      ...
      <section className="flex flex-col items-center px-6 pb-28 pt-20 text-center sm:pt-24">
        ...
        <p className="mt-5 max-w-lg leading-7 text-fd-muted-foreground">
          One binary watches your folders and serves cited passages from every
          document on your disk, to you and to any MCP agent. Nothing leaves
          your machine.
        </p>
        <div className="mt-12">
          <InstallCommand />
