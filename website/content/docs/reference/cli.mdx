...
Supported formats: `.pdf`, `.docx`, `.pptx`, `.md`, `.markdown`, `.txt`, `.html`, `.htm`. Hidden directories and excluded patterns are skipped. A file that fails to parse is counted and skipped; it never aborts the pass.
